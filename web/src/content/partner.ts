...
export const partnerJourney = {
  ...
  stages: {
    ...
    /** brochure-sourced */
    steps: [
      { step: "BEFORE", where: "IDENTIFY · ATHLIMA CONNECT", headline: "Pre-event matchmaking to identify and engage the right people." },
      { step: "DISCOVER", where: "SHOW · ATHLIMAX", headline: "The marketplace to showcase your brand, solutions and innovation." },
      { step: "THINK", where: "LEAD · THE SYMPOSIUM", headline: "Lead conversations that shape the future of Indian sport." },
      { step: "EXPERIENCE", where: "DEMONSTRATE · ACTIV8", headline: "Bring your brand to life through performance, wellness and participation." },
      { step: "CONNECT", where: "BUILD · HOSTED MEETINGS", headline: "Curated, high-value conversations with decision-makers." },
      { step: "CULTURE", where: "DEEPEN · AFTERHOURS", headline: "Strengthen relationships in a relaxed, high-energy environment." },
      { step: "LEGACY", where: "INSPIRE · ATHLIMA 20", headline: "Support and celebrate the next generation, creating a legacy beyond the event." },
